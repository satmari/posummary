...
class CreateCuttingBansekOutputUndosTable extends Migration {
	...
	public function up()
	{
		Schema::create('cutting_bansek_output_undos', function(Blueprint $table)
		{
			// $table->increments('id');
	...
	{
		Schema::drop('cutting_bansek_output_undos');
	}
