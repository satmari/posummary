                    ...
                    -->
                        <thead>
                        	...
                        	<tr>-->
                                ...
                                {{-- <th><span style="color:#00dcff">TPP</span></th>--}}
                                ...
                                <th><span style="color:blue">Del date</span></th>
    			        ...
    			        @foreach ($data as $req)
                            <tr>
                                ...
                                <td><span style="font-size: 10px;">{{ substr($req->delivery_date_orig,0,11) }}</span></td>

                                <td><span style="font-size: 8px;">{{ $req->flash_type }}</span></td>
                                
                                <td><span style="font-size: 10px;">{{ $req->ec_cost }}</span></td>
                                <td><span style="font-size: 10px;">{{ $req->pref_origin }}</span></td>
                                <td><span style="font-size: 10px;">{{ $req->release }}</span></td>
                                <td><span style="font-size: 10px;">{{ $req->sent_to_inteos }}</span></td>
